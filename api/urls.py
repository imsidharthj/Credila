...
from .views import register_customer, check_eligibility, create_loan, view_loan, view_all_loans
...
urlpatterns = [
    ...
    path('view-loans/<int:customer_id>', view_all_loans, name='view_all_loans'),
]
